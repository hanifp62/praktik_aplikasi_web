...
$classes = ($active ?? false)
            ...
            : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-secondary hover:text-primary hover:bg-surface-sunken hover:border-control transition duration-150 ease-in-out '.$fokus;
@endphp
